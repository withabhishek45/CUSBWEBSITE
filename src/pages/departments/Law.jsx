...
import { FaArrowLeft, FaBalanceScale, FaGraduationCap, FaUsers, FaBook, FaAward, FaCalendar, FaDownload, FaEnvelope, FaPhone, FaArrowRight } from "react-icons/fa";
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="text-center md:text-left">
              ...
              <h1 className="text-4xl font-bold mb-3">Law & Governance</h1>
              <div className="flex flex-wrap justify-center md:justify-start gap-3">
                ...
                <span className="px-3 py-1 bg-white/20 rounded-full text-sm">HOD: Dr. Justice Verma</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            The Department of Law offers integrated and postgraduate programs in law. Our focus is on legal education, research, and producing competent legal professionals with a moot court facility and legal aid clinic.
          </p>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { name: "B.A. LL.B. (Hons)", duration: "5 Years" },
              { name: "LL.M.", duration: "2 Years" },
              { name: "Ph.D. Law", duration: "3-5 Years" },
            ].map((prog, i) => (
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { name: "Dr. Justice Verma", designation: "Professor & Head", spec: "Constitutional Law" },
              { name: "Dr. Advocate Singh", designation: "Associate Professor", spec: "Criminal Law" },
              { name: "Dr. Legal Expert", designation: "Assistant Professor", spec: "Corporate Law" },
            ].map((f, i) => (
        ...
        <section className="bg-gradient-to-r from-slate-700 to-gray-800 rounded-2xl p-6 text-white">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="flex items-center gap-3"><FaEnvelope /><span>law@cusb.ac.in</span></div>
            <div className="flex items-center gap-3"><FaPhone /><span>+91-631-2229510</span></div>
          </div>
          <div className="mt-4">
