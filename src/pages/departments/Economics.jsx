        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="text-center md:text-left">
              <p className="text-green-200 text-sm mb-1">Department of</p>
              <h1 className="text-4xl font-bold mb-3">Economics</h1>
              <div className="flex flex-wrap justify-center md:justify-start gap-3">
                ...
                <span className="px-3 py-1 bg-white/20 rounded-full text-sm">HOD: Dr. Madhav Rao</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            The Department of Economics offers programs in microeconomics, macroeconomics, econometrics, development economics, and public policy. Our focus is on analytical skills and policy research with collaborations with RBI and NITI Aayog.
          </p>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              { name: "M.A. Economics", duration: "2 Years" },
              { name: "Ph.D. Economics", duration: "3-5 Years" },
            ].map((prog, i) => (
              <div key={i} className="bg-gray-50 rounded-xl p-4 hover:bg-green-50 transition">
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { name: "Dr. Madhav Rao", designation: "Professor & Head", spec: "Development Economics" },
              { name: "Dr. Lakshmi Devi", designation: "Associate Professor", spec: "Econometrics" },
              { name: "Dr. Chandrashekhar", designation: "Assistant Professor", spec: "Public Policy" },
            ].map((f, i) => (
              <div key={i} className="bg-gray-50 rounded-xl p-4 flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-600">{f.designation}</p>
        ...
        <section className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl p-6 text-white">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="flex items-center gap-3"><FaEnvelope /><span>economics@cusb.ac.in</span></div>
            <div className="flex items-center gap-3"><FaPhone /><span>+91-631-2229506</span></div>
          </div>
          <div className="mt-4">
            <Link to="/admissions" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-green-600 font-semibold rounded-lg hover:bg-green-50 transition">
