...
import { FaArrowLeft, FaAtom, FaGraduationCap, FaUsers, FaFlask, FaAward, FaCalendar, FaDownload, FaEnvelope, FaPhone, FaArrowRight } from "react-icons/fa";
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className="w-28 h-28 bg-white/20 backdrop-blur rounded-2xl flex items-center justify-center">
              <FaAtom className="text-5xl" />
            </div>
            <div className="text-center md:text-left">
              <p className="text-blue-200 text-sm mb-1">Department of</p>
              <h1 className="text-4xl font-bold mb-3">Physics</h1>
              <div className="flex flex-wrap justify-center md:justify-start gap-3">
                ...
                <span className="px-3 py-1 bg-white/20 rounded-full text-sm">HOD: Dr. Chandrashekhar</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            The Department of Physics offers comprehensive programs in classical, modern, and applied physics. Our focus is on experimental and theoretical physics research with well-equipped laboratories and research facilities.
          </p>
        </section>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          <section className="bg-gradient-to-br from-blue-600 to-indigo-600 rounded-2xl p-6 text-white">
            ...
            <p className="text-blue-100">To be a center of excellence in physics education and research.</p>
          </section>
          <section className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white">
            <h2 className="text-xl font-bold mb-3">Our Mission</h2>
            <p className="text-green-100">To produce physicists equipped for careers in research, industry, and academia.</p>
          </section>
        </div>
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              { name: "M.Sc. Physics", duration: "2 Years" },
              { name: "Ph.D. Physics", duration: "3-5 Years" },
            ].map((prog, i) => (
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              ...
              <tbody>
                {[
                  { day: "Monday", m1: "Mechanics", m2: "EM Theory", eve: "Lab" },
                  { day: "Tuesday", m1: "Quantum", m2: "Thermodynamics", eve: "Problem Solving" },
                  { day: "Wednesday", m1: "Optics", m2: "Modern Physics", eve: "Lab Work" },
                  { day: "Thursday", m1: "EM Theory", m2: "Quantum", eve: "Seminar" },
                  { day: "Friday", m1: "Solid State", m2: "Mechanics", eve: "Project" },
                ].map((row, i) => (
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { name: "Dr. Chandrashekhar", designation: "Professor & Head", spec: "Theoretical Physics" },
              { name: "Dr. Indu Bala", designation: "Associate Professor", spec: "Condensed Matter" },
              { name: "Dr. Ajay Kumar", designation: "Assistant Professor", spec: "Quantum Computing" },
              { name: "Dr. Neelam", designation: "Assistant Professor", spec: "Astrophysics" },
            ].map((f, i) => (
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {["Physics Lab", "Electronics Lab", "Computing Lab", "Astronomy Lab", "Research Lab", "Dark Room"].map((f, i) => (
              <div key={i} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                  <FaAtom className="text-blue-600" />
                </div>
        ...
        <section className="bg-gradient-to-r from-blue-700 to-indigo-700 rounded-2xl p-6 text-white">
          <h2 className="text-xl font-bold mb-4">Contact</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="flex items-center gap-3"><FaEnvelope /><span>physics@cusb.ac.in</span></div>
            <div className="flex items-center gap-3"><FaPhone /><span>+91-631-2229512</span></div>
          </div>
          <div className="mt-4">
            <Link to="/admissions" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-blue-700 font-semibold rounded-lg hover:bg-blue-50 transition">
