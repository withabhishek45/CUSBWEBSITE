...
import { FaArrowLeft, FaHistory, FaGraduationCap, FaUsers, FaBook, FaAward, FaCalendar, FaDownload, FaEnvelope, FaPhone, FaArrowRight } from "react-icons/fa";
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="text-center md:text-left">
              <p className="text-yellow-200 text-sm mb-1">Department of</p>
              <h1 className="text-4xl font-bold mb-3">History</h1>
              <div className="flex flex-wrap justify-center md:justify-start gap-3">
                ...
                <span className="px-3 py-1 bg-white/20 rounded-full text-sm">HOD: Dr. Kanhaiya Lal</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            The Department of History offers comprehensive study of ancient, medieval, and modern history. Our programs focus on historical research, archaeology, and cultural heritage with history museum and archival room.
          </p>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { name: "B.A. (Hons) History", duration: "3 Years" },
              { name: "M.A. History", duration: "2 Years" },
              { name: "Ph.D. History", duration: "3-5 Years" },
            ].map((prog, i) => (
              <div key={i} className="bg-gray-50 rounded-xl p-4 hover:bg-yellow-50 transition">
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { name: "Dr. Kanhaiya Lal", designation: "Professor & Head", spec: "Ancient History" },
              { name: "Dr. Sunita Devi", designation: "Associate Professor", spec: "Medieval History" },
              { name: "Dr. Raghunath", designation: "Assistant Professor", spec: "Modern History" },
            ].map((f, i) => (
              <div key={i} className="bg-gray-50 rounded-xl p-4 flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-600">{f.designation}</p>
        ...
        <section className="bg-gradient-to-r from-yellow-600 to-amber-600 rounded-2xl p-6 text-white">
          <h2 className="text-xl font-bold mb-4">Contact</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="flex items-center gap-3"><FaEnvelope /><span>history@cusb.ac.in</span></div>
            <div className="flex items-center gap-3"><FaPhone /><span>+91-631-2229509</span></div>
          </div>
          <div className="mt-4">
            <Link to="/admissions" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-yellow-600 font-semibold rounded-lg hover:bg-yellow-50 transition">
